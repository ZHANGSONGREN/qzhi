...
/* 7 */
/*!**********************************************!*\
  !*** E:/ym/qzhi/pages.json?{"type":"style"} ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/home/index": { "navigationBarTitleText": "圈子首页", "enablePullDownRefresh": true }, "pages/message/index": { "navigationBarTitleText": "消息" }, "pages/ask/query": { "navigationBarTitleText": "搜索" }, "pages/my/authb": { "navigationBarTitleText": "登录" }, "pages/index/oldvip": { "navigationBarTitleText": "邀请注册" }, "pages/home/themea": { "navigationBarTitleText": "查看文章" }, "pages/home/themeb": { "navigationBarTitleText": "查看文章" }, "pages/my/index": { "navigationBarTitleText": "" }, "pages/my/auth": { "navigationBarTitleText": "微信授权" }, "pages/ask/detail": { "navigationBarTitleText": "详情" }, "pages/ask/comment": { "navigationBarTitleText": "评论" }, "pages/ask/index": { "navigationBarTitleText": "提问" }, "pages/index/index": { "navigationBarTitleText": "说房圈" } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarTitleText": "", "navigationBarBackgroundColor": "#5ac274", "backgroundColor": "#5ac274" } };exports.default = _default;

/***/ }),
/* 8 */
/*!*********************************************!*\
  !*** E:/ym/qzhi/pages.json?{"type":"stat"} ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__81ADA9E" };exports.default = _default;
...
/* 12 */
/*!********************************!*\
  !*** E:/ym/qzhi/common/api.js ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.GET = GET;exports.POST = POST;exports.msg = msg;exports.Modal = Modal;exports.delobj = delobj;exports.localImgs2webImgs = localImgs2webImgs;exports.RndNum = RndNum;exports.askconut = exports.theme = exports.askitem = exports.userInfo = exports.userid = exports.mainlist = exports.isuser = exports.wxid = exports.host = void 0;var host = 'https://xcx.shuofangquan.com/';exports.host = host;
var hostapi = host + '/api/base/';
var upload = host + '/api/base/uploadsum';

var wxid = [];exports.wxid = wxid;
var isuser = false;exports.isuser = isuser;
var mainlist = {};exports.mainlist = mainlist;
var userid = '';exports.userid = userid;

var userInfo = {};exports.userInfo = userInfo;
var askitem = {};exports.askitem = askitem;
var theme = {};exports.theme = theme;
var askconut = 3;exports.askconut = askconut;





function GET(url) {var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var handler = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return request('GET', url, params, handler);
}

// POST请求
function POST(url) {var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var handler = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  return request('POST', url, params, handler);
}

function request(method, url) {var params = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var handler = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
...
function msg(title) {var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2000;
  uni.showToast({
    title: title,
    icon: 'none',
    duration: time });
...
function localImgs2webImgs() {var localImgs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  // 上传的后端url
  var url = upload;
...
module.exports = {
  ...
  // --- 网络请求 ---
  // get
  get: function get(url, data, headers, _success, fail) {var _this = this;
    if (!fail) {fail = function fail() {_this.msg("网络请求失败");};}
    if (!headers) {headers = {};}
    ...
    uni.request({
      ...
      fail: fail,
      complete: function complete() {if (_this.__after != null) {_this.__after();_this.__after = null;}} });

  },
  // post
  post: function post(url, data, contentType, headers, _success2, fail) {var _this2 = this;
  ...
  showLoading: function showLoading(title) {uni.showLoading({ title: title });},
